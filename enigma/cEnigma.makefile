...
# Project name, if there is no src file defined, pmake assumes that the .c file
# has the same name as the project name.
project=cEnigma
...
libs=../mylibs/utility/cVersion.c ../mylibs/utility/cManPage.c