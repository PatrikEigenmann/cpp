# -----------------------------------------------------------------------------------------------
# Samael.Scribe.makefile - This file is the makefile for the tool pmake for the project
# Samael.Scribe. pmake is a tool that reads instructions you give it about how to use a compiler
