# -----------------------------------------------------------------------------------------------
# markdown.makefile - This file is the makefile for the tool pmake for the project markdown.
...
libs=md4c/md4c.c md4c/md4c-html.c md4c/entity.c