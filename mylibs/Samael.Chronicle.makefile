# -----------------------------------------------------------------------------------------------
# Samael.Chronicle.makefile - This file is the makefile for the tool pmake for the project
# Samael.Chronicle. pmake is a tool that reads instructions you give it about how to use a compiler
...
project=bin/libSamael.Chronicle
