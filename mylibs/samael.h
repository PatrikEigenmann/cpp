 ...
 * 1) gcc -shared -o bin/libsamael.so util/cManPage.c util/cProgress.c util/cVersion.c
 ...
 * ********************************************************************************************/
#include "util/cManPage.h"
#include "util/cProgress.h"
#include "util/cVersion.h"
