# -----------------------------------------------------------------------------------------------
# Samael.HuginAndMunin.makefile - This file is the makefile for the tool pmake for the project
# Samael.HuginAndMunin. pmake is a tool that reads instructions you give it about how to use a
# compiler of your choice and then automatically runs the compiler to build your software projects.
# Imagine it as a smart assistant that knows exactly how to compile and prepare all the pieces of your
...
project=bin/libSamael.HuginAndMunin
